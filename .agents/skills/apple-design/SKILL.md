...
name: apple-design
description: >-
  Apple interface design and fluid motion principles distilled from WWDC and translated for web and native apps.
  Activate when designing fluid gestures, spatial consistency, spring physics, or Apple-grade interfaces.
---
