...
name: prototype
description: >-
  Build multiple interactive variations of a UI component with a live switcher for rapid iteration.
  Activate when prototyping UI components, exploring design variants, building interactive mockups, or comparing interaction states.
---
...
4. **The picker is chrome, not a contestant.** Its exact markup, styles, and behavior are specified in `references/picker.md` — copy them verbatim. Its look is not a design decision and never adapts to the project.
