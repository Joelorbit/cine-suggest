...
description: >-
  Select trusted, battle-tested UI component libraries and headless primitives instead of hand-rolling complex widgets.
  Activate when choosing a UI component library, headless primitives (Radix, Base UI, Bits UI), toast, drawer, or dialog packages.
---
