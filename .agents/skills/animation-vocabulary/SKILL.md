...
description: >-
  Precise animation and motion vocabulary for communicating and implementing UI interactions.
  Activate when describing motion intent, prompting AI agents for animations, or refining choreography terms.
---
